package cn.deercare.finals.wechat;
...
public class WechatIFSInfo {
    ...
    // 付款到零钱接口
    public static final String POST_PAY_SMALL_CHANGE = "https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers";

    // 查询付款到零钱接口
    public static final String POST_SMALL_CHANGE = "https://api.mch.weixin.qq.com/mmpaymkttransfers/gettransferinfo";
